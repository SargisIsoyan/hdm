package am.iunetworks.ecr.client.V03;

import am.iunetworks.ecr.client.V03.exception.ECRException;
import am.iunetworks.ecr.client.V03.pojo.*;
...
public class ECRSampleClient {
    ...
    private static final byte[] PROTOCOL_VERSION = new byte[]{(byte) 0x00, (byte) 0x03};
    ...
    public PrintReceiptResponse printReceipt(int printMode, List<Item> items, double paidAmount) throws Exception {
        return printReceipt(printMode, items, paidAmount, 0, false);
    }
     ...
     * @throws com.fasterxml.jackson.core.JsonProcessingException @request cannot be serialized to JSON
     */
    public PrintReceiptResponse printReceipt(int printMode, List<Item> items, double paidAmount, double paidAmountCard, boolean useExtPOS) throws Exception {
